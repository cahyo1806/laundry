      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Hi, Rahandyan Cahyo</div>
            </a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item{{ request()->is('pegawai') ? ' active' : '' }}"><a href="{{ url('/pegawai') }}"><i class="fas fa-user-friends"></i><span> Pegawai</span></a></li>
            <li class="nav-item{{ request()->is('barang') ? ' active' : '' }}"><a href="{{ url('/barang') }}"><i class='far fa-folder fa-9x' style='color:#000000'></i><span>Barang</span></a></li>
            <li class="nav-item{{ request()->is('pembelianbarang') ? ' active' : '' }}"><a href="{{ url('/pembelianbarang') }}"><i class='fas fa-clipboard-list fa-9x' style='color:#000000'></i><span>Pembelian Barang</span></a></li>
            <li class="nav-item{{ request()->is('member') ? ' active' : '' }}"><a href="{{ url('/member') }}"><i class="fas fa-chalkboard-teacher"></i><span>Member</span></a></li>
            <li class="nav-item{{ request()->is('datalaundrymember') ? ' active' : '' }}"><a href="{{ url('/datalaundrymember') }}"><i class='far fa-address-card fa-9x' style='color:#000000'></i><span>Data Laundry Member</span></a></li>
            <li class="nav-item{{ request()->is('datalaundrynonmember') ? ' active' : '' }}"><a href="{{ url('/datalaundrynonmember') }}"><i class='fas fa-minus-square fa-9x' style='color:#000000'></i><span>Data Laundry Non Member</span></a></li>
          </ul>
            </li>
          </ul>
